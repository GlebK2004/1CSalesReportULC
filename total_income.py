...
def total_income():
    trio1 = ['Бровко Екатерина', 'Перхова Ангелина', 'Михалкин Виктор']
    trio2 = ['Новосад Марина', 'Данилов Дмитрий', 'Мурзич Павлина']
    trio3 = ['Зарецкая Юлия', 'Чудук Александр', 'Лавринович Ирина']
    trio4 = []
    ...
    new_names = {
        'Михалкин | Перхова - Бровко': tuple(trio1),
        'Данилов | Новосад - Мурзич': tuple(trio2),
        'Чудук | Лавринович - Зарецкая': tuple(trio3),
    }
    ...
    plt.title('Общий доход по тройкам', fontsize=22)
    plt.grid(axis='y')
